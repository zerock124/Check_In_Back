...
namespace Check_In.Extensions
{
    public static class ImageExtensions
    {
        ...
        /// </code>
        /// </example>
        public static Image Resize(this Image image, int width, int height, ImageResizeMode mode, Color? background = null)
        {
